PREDICT_SET = {
    '<program>': ['beam', 'brick', 'field', 'glass', 'roof', 'tile', 'wall'],  # prod 1
    '<program_body>': ['wall'],  # prod 2
    '<program_body_1>': ['beam', 'brick', 'field', 'glass', 'tile'],  # prod 3
    '<program_body2>': ['id'],  # prod 4
    '<program_body2_1>': ['blueprint'],  # prod 5
    '<global>': ['roof'],  # prod 6
    '<global_1>': ['beam', 'brick', 'field', 'glass', 'tile', 'wall'],  # prod 7
    '<global_dec>': ['beam', 'brick', 'glass', 'tile', 'wall'],  # prod 8
    '<global_dec_1>': ['house'],  # prod 9
    '<global_dec_2>': ['cement'],  # prod 10
    '<global_var>': ['beam', 'brick', 'glass', 'tile'],  # prod 11
    ...
    '<two_d_end>': ['='],  # prod 36
    '<two_d_end_1>': [';'],  # prod 37
    '<elements>': ['brick_lit', 'fragile', 'glass_lit', 'solid', 'tile_lit'],  # prod 38
    '<mult_elem>': [','],  # prod 39
    '<mult_elem_1>': ['}'],  # prod 40
    '<mult_elem2>': [','],  # prod 41
    ...
    '<struct_dec>': ['{'],  # prod 67
    '<struct_members>': ['beam', 'brick', 'glass', 'tile', 'wall'],  # prod 68
    '<data_type_dec>': ['beam', 'brick', 'glass', 'tile'],  # prod 69
    '<data_type_dec_1>': ['wall'],  # prod 70
    '<array>': ['['],  # prod 71
    '<array_1>': [';'],  # prod 72
    '<array2>': ['['],  # prod 73
    '<array2_1>': [';'],  # prod 74
    '<mult_members>': ['beam', 'brick', 'glass', 'tile', 'wall'],  # prod 75
    '<mult_members_1>': ['}'],  # prod 76
    '<struct_id_end>': ['id'],  # prod 77
    '<struct_id_end_1>': [';'],  # prod 78
    '<struct_init>': ['='],  # prod 79
    '<struct_init_1>': [';'],  # prod 80
    '<struct_elem>': ['brick_lit', 'fragile', 'glass_lit', 'solid', 'tile_lit', 'wall_lit'],  # prod 81
    '<struct_elem_1>': ['{'],  # prod 82
    '<struct_value>': ['brick_lit', 'fragile', 'glass_lit', 'solid', 'tile_lit'],  # prod 83
    '<struct_value_1>': ['wall_lit'],  # prod 84
    '<mult_struct_elem>': [','],  # prod 85
    '<mult_struct_elem_1>': ['}'],  # prod 86
    '<struct_arr_elem>': ['brick_lit', 'fragile', 'glass_lit', 'solid', 'tile_lit', 'wall_lit'],  # prod 87
    '<struct_arr_elem_1>': ['{'],  # prod 88
    '<struct_elements>': ['brick_lit', 'fragile', 'glass_lit', 'solid', 'tile_lit', 'wall_lit'],  # prod 89
    ...
    '<global_const_type>': ['beam', 'brick', 'glass', 'tile'],  # prod 98
    ...
    '<return_type>': ['beam', 'brick', 'glass', 'tile'],  # prod 115
    '<return_type_1>': ['field'],  # prod 116
    '<param_list>': ['beam', 'brick', 'glass', 'tile', 'wall'],  # prod 117
    '<param_list_1>': [')'],  # prod 118
    '<mult_param>': [','],  # prod 119
    '<mult_param_1>': [')'],  # prod 120
    '<func_body>': ['beam', 'brick', 'cement', 'glass', 'house', 'tile', 'wall'],  # prod 121
    '<func_body_1>': ['++', '--', 'crack', 'do', 'for', 'home', 'id', 'if', 'mend', 'room', 'view', 'while', 'write'],  # prod 122
    '<func_body2>': ['++', '--', 'beam', 'brick', 'cement', 'crack', 'do', 'for', 'glass', 'home', 'house', 'id', 'if', 'mend', 'room', 'tile', 'view', 'wall', 'while', 'write'],  # prod 123
    '<func_body2_1>': ['}'],  # prod 124
    '<local>': ['beam', 'brick', 'cement', 'glass', 'house', 'tile', 'wall'],  # prod 125
    '<declaration>': ['beam', 'brick', 'glass', 'tile', 'wall'],  # prod 126
    '<declaration_1>': ['house'],  # prod 127
    '<declaration_2>': ['cement'],  # prod 128
    '<variable>': ['beam', 'brick', 'glass', 'tile'],  # prod 129
    ...
    '<const_type>': ['beam', 'brick', 'glass', 'tile'],  # prod 153
    ...
    '<init_value>': ['(', '-', 'brick_lit', 'fragile', 'glass_lit', 'id', 'solid', 'tile_lit'],  # prod 164
    '<init_value_1>': ['!', '++', '--'],  # prod 165
    '<value_exp>': ['brick_lit', 'fragile', 'glass_lit', 'id', 'solid', 'tile_lit'],  # prod 166
    '<value_exp_1>': ['('],  # prod 167
    '<value_exp_2>': ['-'],  # prod 168
    '<value_type>': ['id'],  # prod 169
    '<value_type_1>': ['brick_lit', 'fragile', 'glass_lit', 'solid', 'tile_lit'],  # prod 170
    '<id_type>': ['!=', '%', '&&', '(', ')', '*', '+', '++', '-', '--', '.', '/', ';', '<', '<=', '==', '>', '>=', '[', ']', '||'],  # prod 171
    '<id_type_1>': ['!=', '%', '&&', ')', '*', '+', '-', '/', ';', '<', '<=', '==', '>', '>=', ']', '||'],  # prod 172
    '<id_type2>': ['!=', '%', '&&', ')', '*', '+', '++', '-', '--', '.', '/', ';', '<', '<=', '==', '>', '>=', '[', ']', '||'],  # prod 173
    '<id_type2_1>': ['!=', '%', '&&', '(', ')', '*', '+', '-', '/', ';', '<', '<=', '==', '>', '>=', ']', '||'],  # prod 174
    ...
    '<func_argu>': ['!', '(', '++', '-', '--', 'brick_lit', 'fragile', 'glass_lit', 'id', 'solid', 'tile_lit'],  # prod 186
    '<func_argu_1>': ['(', 'brick_lit', 'id', 'wall_lit'],  # prod 187
    ...
    '<unary_op_1>': ['--'],  # prod 195
    '<group>': ['('],  # prod 196
    '<negative_type>': ['brick_lit', 'fragile', 'glass_lit', 'id', 'solid', 'tile_lit'],  # prod 197
    ...
    '<id_type4_1>': ['++', '--'],  # prod 243
    '<id_type4_2>': ['%=', '*=', '+=', '-=', '.', '/=', '=', '['],  # prod 244
    '<assign_value>': ['!', '(', '++', '-', '--', 'brick_lit', 'fragile', 'glass_lit', 'id', 'solid', 'tile_lit'],  # prod 245
    '<assign_value_1>': ['(', 'brick_lit', 'id', 'wall_lit'],  # prod 246
    '<assign_op>': ['='],  # prod 247
    ...
    '<else_statement_1>': ['++', '--', 'beam', 'brick', 'cement', 'crack', 'do', 'door', 'for', 'glass', 'ground', 'home', 'house', 'id', 'if', 'mend', 'room', 'tile', 'view', 'wall', 'while', 'write', '}'],  # prod 255
    ...
    '<case_exp>': ['(', '-', 'brick_lit', 'fragile', 'solid', 'tile_lit'],  # prod 263
    '<case_type>': ['brick_lit', 'fragile', 'solid', 'tile_lit'],  # prod 264
    ...
    '<case_group>': ['('],  # prod 271
    '<case_negative>': ['brick_lit', 'fragile', 'solid', 'tile_lit'],  # prod 272
    '<case_negative_1>': ['('],  # prod 273
    '<case_op>': ['!=', '%', '&&', '*', '+', '-', '/', '<', '<=', '==', '>', '>=', '||'],  # prod 274
    '<case_op_1>': [')', ':'],  # prod 275
    '<case_body>': ['++', '--', 'crack', 'do', 'for', 'home', 'id', 'if', 'mend', 'room', 'view', 'while', 'write'],  # prod 276
    '<case_body_1>': ['{'],  # prod 277
    '<case_body_2>': ['door', 'ground', '}'],  # prod 278
    '<mult_smt>': ['++', '--', 'crack', 'do', 'for', 'home', 'id', 'if', 'mend', 'room', 'view', 'while', 'write'],  # prod 279
    '<mult_smt_1>': ['door', 'ground', '}'],  # prod 280
    '<for_statement>': ['for'],  # prod 281
    '<for_dec>': ['beam', 'brick', 'glass', 'tile'],  # prod 282
    ...
    '<home_value>': ['!', '(', '++', '-', '--', 'brick_lit', 'fragile', 'glass_lit', 'id', 'solid', 'tile_lit'],  # prod 289
    '<home_value_1>': ['(', 'brick_lit', 'id', 'wall_lit'],  # prod 290
}
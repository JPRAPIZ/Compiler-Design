FIRST_SET = {
    ...
    "<initializer>": {"=", "λ"},
    "<mult_var>": {",", "λ"},
    "<expression>": {"id", "(", "tile_lit", "glass_lit", "brick_lit", "solid", "fragile", "-", "!", "++", "--"},
    "<exp_op>": {"-", "+", "*", "/", "%", "<", "<=", ">", ">=", "==", "!=", "&&", "||", "λ"},
    "<id_type>": {"(", "[", ".", "++", "--", "λ"},
    "<id_type2>": {"(", "[", "."},
    "<arr_struct>": {"[", "."},
    ...
    "<assign_end>": {"=", "++", "--", "+=", "-=", "*=", "/=", "%="},
    "<compound_op>": {"+=", "-=", "*=", "/=", "%="},
    "<assign_rhs>": {"id", "(", "tile_lit", "glass_lit", "brick_lit", "solid", "fragile", "wall_lit", "-", "!", "++", "--"},
    "<assign_exp>": {"-", "+", "*", "/", "%", "<", "<=", ">", ">=", "==", "!=", "&&", "||", "λ"},
    "<assign_prefix_exp>": {"id", "("},
    "<if_statement>": {"if"},
    "<condition>": {"id", "(", "tile_lit", "glass_lit", "brick_lit", "solid", "fragile", "-", "!", "++", "--"},
    "<cond_op>": {"-", "+", "*", "/", "%", "<", "<=", ">", ">=", "==", "!=", "&&", "||", "λ"},
    "<prefix_cond_exp>": {"id", "("},
    ...
    "<for_exp>": {"id", "(", "tile_lit", "glass_lit", "brick_lit", "solid", "fragile", "-", "!", "++", "--"},
    "<for_op>": {"-", "+", "*", "/", "%", "<", "<=", ">", ">=", "==", "!=", "&&", "||", "λ"},
    "<prefix_for_exp>": {"id", "("},
